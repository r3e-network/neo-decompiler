...
use crate::decompiler::ir::{
    BinOp, Block, ControlFlow, Expr, Intrinsic, SemanticCallTarget, Stmt, UnaryOp,
};
use crate::instruction::OpCode;

use super::expr::{render_expr, render_vm_condition, ExprContext};
use super::plan::{csharp_type, DeclarationKind, DeclarationPlan, ScopeId, ScopeTree};
...
impl StatementRenderer<'_> {
    ...
    fn render_for_initializer(&self, statement: &Stmt) -> String {
        match statement {
    ...
    fn render_for_update(&self, expression: &Expr) -> String {
        match expression {
            Expr::Unary {
                op: UnaryOp::Inc,
                operand,
    ...
    fn render_expression_statement(&self, expression: &Expr) -> String {
    ...
    fn render_exception(&self, exception: &str, value: Option<&Expr>) -> String {
        value.map_or_else(
    ...
    fn render_vm_throw(&self, value: Option<&Expr>) -> String {
    ...
    fn render_return(&self, value: &Expr) -> String {
    ...
    fn render_typed_value(&self, value: &Expr, target_type: &str) -> String {
    ...
    fn hoisted_declarations(&self, scope: ScopeId, indent: usize) -> Vec<String> {
        self.plan
            .declarations
            .values()
            .filter(|declaration| {
