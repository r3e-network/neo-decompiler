...
pub enum OpCode {
    ...
    PUSHT, PUSHF, PUSHA, PUSHNULL, PUSHDATA1, PUSHDATA2, PUSHDATA4, PUSHM1,
    ...
    NOP, JMP, JMP_L, JMPIF, JMPIF_L, JMPIFNOT, JMPIFNOT_L,
...
impl OpCode {
    ...
    pub fn is_call(&self) -> bool {
        matches!(self, OpCode::CALL | OpCode::CALL_L | OpCode::CALLA | OpCode::CALLT | OpCode::SYSCALL)
    }
    ...
    pub fn is_terminator(&self) -> bool {
        matches!(self, 
            ...
            OpCode::JMPNE | OpCode::JMPNE_L | OpCode::JMPGT | OpCode::JMPGT_L |
            OpCode::JMPGE | OpCode::JMPGE_L | OpCode::JMPLT | OpCode::JMPLT_L |
            OpCode::JMPLE | OpCode::JMPLE_L | OpCode::RET | OpCode::ABORT | OpCode::THROW
        )
    }
    ...
    pub fn has_long_form(&self) -> bool {
        matches!(self,
            OpCode::JMP | OpCode::JMPIF | OpCode::JMPIFNOT | OpCode::JMPEQ |
            OpCode::JMPNE | OpCode::JMPGT | OpCode::JMPGE | OpCode::JMPLT |
            OpCode::JMPLE | OpCode::CALL | OpCode::TRY | OpCode::ENDTRY
        )
    }
    ...
    pub fn is_long_form(&self) -> bool {
        matches!(self,
            OpCode::JMP_L | OpCode::JMPIF_L | OpCode::JMPIFNOT_L | OpCode::JMPEQ_L |
            OpCode::JMPNE_L | OpCode::JMPGT_L | OpCode::JMPGE_L | OpCode::JMPLT_L |
            OpCode::JMPLE_L | OpCode::CALL_L | OpCode::TRY_L | OpCode::ENDTRY_L
        )
    }
}
...
pub enum UnaryOperator {
    Not, Negate, BoolNot, Abs, Sign, Sqrt, BitwiseNot,
}
